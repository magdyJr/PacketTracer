...
public class WindowOfInterfaces extends javax.swing.JFrame {

    SniffER sniffer;
    public WindowOfInterfaces() {
    ...
    public WindowOfInterfaces(SniffER sn) {
        this.sniffer=sn;
        initComponents();
        ListNetworkInterfaces();
        textField1.requestFocus();
    ...
    public void ListNetworkInterfaces() {
        this.sniffer.NETWORK_INTERFACES = JpcapCaptor.getDeviceList();
        jTextArea1.setText("");
        for (int i = 0; i < this.sniffer.NETWORK_INTERFACES.length; i++) {
            jTextArea1.append(
                    "\n\n-----------------------------------------------------------------------Interface (" + i
                    + ") -----------------------------------------------------------------------");
    ...
    public void ChooseInterface() {
        ...
        if (TEMP > -1 && TEMP < sniffer.COUNTER) {
            ...
            WindowOfInterfaces nw = new WindowOfInterfaces();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WindowOfInterfaces.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new WindowOfInterfaces().setVisible(true);
            }
        });
    }
